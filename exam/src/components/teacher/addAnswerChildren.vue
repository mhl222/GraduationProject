          ...
          <el-card class="block">
            <div class="left">
              <ul>
                <li>
                  <span>试题难度:</span>
                  <el-select v-model="difficultyValue" placeholder="试题难度" style="width: 150px;margin-left: 10px;">
                ...
                <li>
                  <span>选择题数量：</span>
                  <el-input type="text" v-model="changeNumber" style="width: 50px;" maxlength="2"></el-input>
                </li>
                <li>
                  <span>填空题数量：</span>
                  <el-input type="text" v-model="fillNumber" style="width: 50px;" maxlength="2"></el-input>
                </li>
                <li>
                  <span>判断题数量：</span>
                  <el-input type="text" v-model="judgeNumber" style="width: 50px;" maxlength="2"></el-input>
                </li>
                <li>
            ...
            <div class="right">
              <el-table ref="multipleTable" :data="tableData" tooltip-effect="dark" style="width: 100%"
                @selection-change="handleSelectionChange" height="250">
                <el-table-column type="selection" width="55">
                </el-table-column>
                <el-table-column label="章节" prop="ch"  width="120">
                  
                </el-table-column>
                <el-table-column  prop="num" label="数量" width="220">
                  <template slot-scope="scope"   >
                    <el-input-number  v-model="scope.row.num" :min="1"  width="120"></el-input-number>
                  </template>
                </el-table-column>
